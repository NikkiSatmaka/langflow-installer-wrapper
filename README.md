...
One-click installer for [Langflow](https://github.com/langflow-ai/langflow) **1.11.6** on Windows, macOS, and Linux — no admin rights required.
...
- Install Langflow 1.11.6 (with the Google, Ollama, Azure AI, and PostgreSQL integrations from the official Docker image)
